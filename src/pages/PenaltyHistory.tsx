...
const PenaltyHistory = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Add penalty history check logic here
    alert("Penalty history check not implemented.");
  };
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex flex-col items-center py-8 flex-grow">
        <div className="w-full max-w-xl bg-white rounded-lg shadow-md p-6 border border-gray-200" style={{ boxShadow: '0 4px 24px 0 rgba(0,0,0,0.10)' }}>
          <h1 className="text-2xl font-bold text-center mb-2">Licence Penalty/Points History</h1>
          <p className="text-sm text-gray-700 text-center mb-6">
            View your demerit points history and traffic violation records
          </p>
          <hr className="mb-6" />
